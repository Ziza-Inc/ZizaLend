...
/**
 * Metadata for the admin governance route.
 *
...
export async function generateMetadata({ params }: LayoutProps): Promise<Metadata> {
  ...
  return buildRouteMetadata({ locale, key: "adminGovernance" });
}

export default function AdminGovernanceLayout({ children }: LayoutProps) {
  return <>{children}</>;
}
