# ZizaLend Smart Contracts

Soroban smart contracts for the ZizaLend decentralized lending platform on Stellar. These contracts handle NFT minting, loan management, and lending pool operations.

## Overview

ZizaLend uses three core smart contracts:
